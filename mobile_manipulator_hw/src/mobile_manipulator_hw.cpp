...
int main(int argc, char** argv) {
    ros::init(argc, argv, "mobile_manipulator_hw");
    ros::NodeHandle nh;
    ...
    try {
        ...
        std::shared_ptr<generally::MobileManipulatorHW> MobileManipulatorHW = std::make_shared<generally::MobileManipulatorHW>();
