...
namespace generally {
    ...
    class MobileManipulatorHW : public GenerallyHW {
    public:
        MobileManipulatorHW() = default;
    ...
    private:
        ...
        MobileManipulatorMotorData jointData_[8]{};  // NOLINT(modernize-avoid-c-arrays)
...
}  // namespace MobileManipulator_webots