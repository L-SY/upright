 ...
 */
uint16_t DIABLO::Utility::update_crc16(const void* data, size_t len)
{
  uint16_t crc = 0;
...
bool DIABLO::Utility::verify_crc16(const void* data, size_t len)
{
  uint16_t crc = DIABLO::Utility::update_crc16(data, len - 2);
  const uint8_t* p = (const uint8_t*)data;
