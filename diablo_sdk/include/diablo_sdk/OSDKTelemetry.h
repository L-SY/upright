...
public:
  ...
  /**
   * @brief update configuration of telemetry setting. If the total bitrate exceeds the bandwidth, it will drop the
   * changes and reset to previous configration
