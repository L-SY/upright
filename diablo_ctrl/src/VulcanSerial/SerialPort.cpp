...
#include "diablo_ctrl/VulcanSerial/Exception.h"
...
SerialPort::SerialPort(const std::string& device, BaudRate baudRate, NumDataBits numDataBits, Parity parity,
...
void SerialPort::ConfigureTermios()
{
  ...
  // which read() returns is instead controlled by c_cc[VMIN] and c_cc[VTIME]
