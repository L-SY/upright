...
public:
   ...
   * @note this function will automatically transmit two packets of "obtain control" frame. If control authorization is
   * given to virtual RC. it will exit the program
   */
