...
public:
   ...
   * urdf of robot. Set up transmission
   *
...
protected:
  ...
  hardware_interface::EffortJointInterface
      effortJointInterface_; // NOLINT(misc-non-private-member-variables-in-classes)
  std::vector<hardware_interface::JointHandle>
      effort_joint_handles_{}; // NOLINT(misc-non-private-member-variables-in-classes)
  hardware_interface::PositionJointInterface
      positionJointInterface_; // NOLINT(misc-non-private-member-variables-in-classes)
  std::vector<hardware_interface::JointHandle>
      position_joint_handles_{}; // NOLINT(misc-non-private-member-variables-in-classes)
