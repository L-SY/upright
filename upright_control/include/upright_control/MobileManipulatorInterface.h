...
public:
  ...
  const ocs2::vector_t& getInitialState()
  {
  ...
  {
    return settings_.sqp;
  }

  ocs2::mpc::Settings& mpcSettings()
  {
    return settings_.mpc;
  }
  ...
  const MobileManipulatorInfo& getManipulatorModelInfo() const
  {
    return *mobileManipulatorInfo_;
  }
...
private:
  ...
  std::unique_ptr<ocs2::StateConstraint> get_obstacle_constraint(ocs2::PinocchioInterface& pinocchio_interface,
                                                                 ocs2::PinocchioGeometryInterface& geom_interface,
                                                                 const ObstacleSettings& settings,
                                                                 const std::string& library_folder,
                                                                 bool recompile_libraries);

  // Soft static obstacle avoidance constraint.
  std::unique_ptr<ocs2::StateCost> get_soft_obstacle_constraint(ocs2::PinocchioInterface& pinocchio_interface,
                                                                ocs2::PinocchioGeometryInterface& geom_interface,
                                                                const ObstacleSettings& settings,
                                                                const std::string& library_folder,
                                                                bool recompile_libraries);
  ...
  get_balancing_constraint(const ocs2::PinocchioEndEffectorKinematicsCppAd& end_effector_kinematics,
                           bool recompileLibraries);

  // Soft version of the balancing constraints (i.e. formulated as a cost via
  // penalty functions).
  std::unique_ptr<ocs2::StateInputCost>
  get_soft_balancing_constraint(const ocs2::PinocchioEndEffectorKinematicsCppAd& end_effector_kinematics,
                                bool recompileLibraries);

  std::unique_ptr<ocs2::StateInputConstraint>
  get_object_dynamics_constraint(const ocs2::PinocchioEndEffectorKinematicsCppAd& end_effector_kinematics,
                                 bool recompileLibraries);

  std::unique_ptr<ocs2::StateInputCost>
  get_soft_object_dynamics_constraint(const ocs2::PinocchioEndEffectorKinematicsCppAd& end_effector_kinematics,
                                      bool recompileLibraries);

  std::unique_ptr<ocs2::StateInputConstraint>
  get_contact_force_constraint(const ocs2::PinocchioEndEffectorKinematicsCppAd& end_effector_kinematics,
                               bool recompileLibraries);

  std::unique_ptr<ocs2::StateInputCost>
  get_soft_contact_force_constraint(const ocs2::PinocchioEndEffectorKinematicsCppAd& end_effector_kinematics,
                                    bool recompileLibraries);
};
